...
| 场景               | 使用工具                        | 模型    | 原因                 |
| ------------------ | ------------------------------- | ------- | -------------------- |
| **代码开发** | Claude Code（GLM-5.1）            | GLM-5.1   | 开发任务，主会话模型 |
| **代码审查** | `/codex:review`               | GPT-5.5 | 编码能力强，独立视角 |
| **对抗审查** | `/codex:adversarial-review`    | GPT-5.5 | 主动挑错，提升质量   |
| **Bug 修复** | `/codex:rescue`               | GPT-5.5 | 诊断+修复一步到位    |
| **后台审查** | Stop Hook（Codex Review Gate）  | GPT-5.5 | 每次会话结束自动审查 |
